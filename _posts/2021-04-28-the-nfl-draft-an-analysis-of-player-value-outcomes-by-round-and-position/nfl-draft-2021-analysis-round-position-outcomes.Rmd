...
description: |
  A look at the NFL draft, how career value is distributed historically by draft round and player position, and some interesting storylines to follow for the NFL's big night in 2021
author:
  - name: "Jeff Asselin"
...
How about if we summarize by position? As you can see from the table below, positions with a proper sample and the highest 'Approximate value' per game are Tackle, Quarterback, Guard, and Center. This tells you that:
  ...
  * A team should heavily consider investing a significant amount of draft captial into these positions
